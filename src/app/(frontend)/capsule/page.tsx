...
const LoadingFallback = () => (
  <div className="min-h-screen bg-black text-white flex items-center justify-center relative overflow-hidden">
    ...
    >
      ...
      />
      <p className="text-gray-400 font-medium tracking-wide">Loading capsule...</p>
    </motion.div>
  </div>
);
        ...
        >
          ...
          <div className="bg-gray-900/50 border border-gray-800 rounded-2xl p-8 mb-8">
            <div className="flex items-start justify-between mb-6">
              <div className="flex items-center space-x-4">
                <motion.div
                  className={`w-16 h-16 rounded-full flex items-center justify-center ${capsule.isLocked
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="md:col-span-2">
              <motion.div
                className="bg-gray-900/40 backdrop-blur-md border border-white/10 rounded-2xl p-8 hover:border-cyan-500/30 transition-all duration-300"
            ...
            <div className="space-y-6">
              ...
              {/* Blockchain Info */}
              <motion.div
                className="bg-gray-900/40 backdrop-blur-md border border-white/10 rounded-2xl p-6 hover:border-cyan-500/30 transition-all duration-300"
                whileHover={{ y: -5, boxShadow: "0 20px 40px -20px rgba(0,0,0,0.5)" }}
              ...
              >
                <h4 className="text-lg font-semibold text-cyan-400 mb-4 flex items-center gap-2">
                  <ExternalLink className="w-4 h-4" /> Blockchain Details
                </h4>
                <div className="space-y-4">
                  <div>
                    <p className="text-sm text-gray-400">Network</p>
                    <p className="font-mono text-sm text-gray-200">{capsule.metadata.network}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-400">Block Height</p>
                    <p className="font-mono text-sm text-gray-200">{capsule.metadata.blockHeight.toLocaleString()}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-400">Contract</p>
                    <div className="flex items-center space-x-2">
                      <p className="font-mono text-sm truncate text-gray-200">{capsule.metadata.contractAddress}</p>
                      <motion.button
                  ...
                  <motion.button
                    className="w-full py-2.5 px-4 bg-cyan-900/20 hover:bg-cyan-900/30 border border-cyan-500/30 rounded-xl text-sm transition-all flex items-center justify-center space-x-2 text-cyan-400"
                    whileHover={{ scale: 1.02, backgroundColor: "rgba(22, 78, 99, 0.4)" }}
                    whileTap={{ scale: 0.98 }}
                  >
              ...
              >
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-3 p-3 bg-white/5 rounded-xl border border-white/5">
                    {capsule.lockType === 'time' && <Clock className="w-5 h-5 text-cyan-400" />}
                    ...
                    <div>
                      <p className="font-medium capitalize text-white">{capsule.lockType} Lock</p>
              ...
              >
                ...
                <div className="space-y-3">
                  <motion.button
                    className="w-full py-2.5 px-4 bg-gray-800/50 hover:bg-gray-700/50 border border-white/5 rounded-xl text-sm transition-colors flex items-center justify-center gap-2"
                    whileHover={{ scale: 1.02, backgroundColor: "rgba(31, 41, 55, 0.8)" }}
                    whileTap={{ scale: 0.98 }}
                  >
                    <Share2 className="w-4 h-4" /> Share Capsule
                  </motion.button>
                  <motion.button
                    className="w-full py-2.5 px-4 bg-gray-800/50 hover:bg-gray-700/50 border border-white/5 rounded-xl text-sm transition-colors flex items-center justify-center gap-2"
                    whileHover={{ scale: 1.02, backgroundColor: "rgba(31, 41, 55, 0.8)" }}
                  ...
                  <motion.button
                    className="w-full py-2.5 px-4 bg-red-900/20 hover:bg-red-900/30 border border-red-500/30 rounded-xl text-sm transition-colors text-red-400 flex items-center justify-center gap-2"
                    whileHover={{ scale: 1.02, backgroundColor: "rgba(127, 29, 29, 0.3)" }}
                    whileTap={{ scale: 0.98 }}
                  >
                    <MessageSquare className="w-4 h-4" /> Report Content
                  </motion.button>
                </div>
              </motion.div>
            </div>
