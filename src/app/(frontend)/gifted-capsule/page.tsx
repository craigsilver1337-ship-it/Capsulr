      ...
      >
        ...
        >
          <motion.div
            ...
            className="inline-flex items-center gap-4 relative mb-6"
          >
            <Gift className="w-10 h-10 text-cyan-400" />
            <h1 className="text-6xl font-bold bg-gradient-to-r from-cyan-400 via-purple-300 to-pink-500 bg-clip-text text-transparent tracking-tight">
              Gifted Capsules
            </h1>
            <Gift className="w-10 h-10 text-cyan-400" />
          </motion.div>
        ...
        {/* Stats */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16 relative z-10 max-w-5xl mx-auto">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            {/* Background Icon */}
            <Gift strokeWidth={1} className="absolute -right-4 -bottom-4 w-32 h-32 text-cyan-500/10 rotate-[-10deg] transition-transform duration-500 group-hover:rotate-0 group-hover:scale-110 opacity-20" />

            <div className="relative z-10">
              <div className="flex items-center justify-between mb-8">
                <h3 className="text-xs font-bold uppercase tracking-widest text-gray-500 group-hover:text-cyan-400/80 transition-colors">Total Gifted</h3>
          ...
          <div className="bg-slate-800/50 backdrop-blur-sm rounded-full p-1 border border-slate-700">
            {['all', 'locked', 'unlocked'].map((filter) => (
              <motion.button
                ...
                className={`px-6 py-2 rounded-full text-sm font-medium transition-all duration-300 ${selectedFilter === filter
                ...
                {currentCapsules.map((capsule, index) => {
                  ...
                  return (
                    <motion.div
                      ...
                      className={`relative overflow-hidden rounded-2xl backdrop-blur-sm border transition-all duration-500 cursor-pointer group ${rarityColors[capsule.rarity]
                        } ${hoveredCapsule === capsule.id ? `shadow-2xl ${rarityGlows[capsule.rarity]} scale-105` : 'shadow-lg'
                        }`}
                    >
                      {/* Rarity Glow Effect */}
                      <div className={`absolute inset-0 opacity-20 bg-gradient-to-br ${capsule.rarity === 'legendary' ? 'from-amber-400 to-orange-500' :
                      ...
                      <div className="relative p-6">
                        ...
                        <div className="flex items-center justify-between mb-4">
                          <div className="flex items-center gap-3">
                            <div className={`p-3 rounded-xl ${capsule.isUnlocked ? 'bg-green-500/20 text-green-400' : 'bg-slate-700/50 text-slate-400'
                              }`}>
                          ...
                          {/* Status Icon */}
                          <div className={`p-2 rounded-lg ${capsule.isUnlocked ? 'bg-green-500/20' : 'bg-red-500/20'
                            }`}>
                            {capsule.isUnlocked ? (
                        ...
                        <div className="space-y-3 mb-4">
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <span className={`capitalize font-medium ${capsule.rarity === 'legendary' ? 'text-amber-400' :
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <span className={`font-medium ${capsule.isUnlocked ? 'text-green-400' : 'text-red-400'
                              }`}>
                      ...
                      <div className="absolute top-4 right-4">
                        <div className={`px-2 py-1 rounded-full text-xs font-medium ${capsule.rarity === 'legendary' ? 'bg-amber-500/20 text-amber-400 border border-amber-500/30' :
          ...
          >
            <div className="relative w-32 h-32 mx-auto mb-8">
              ...
              <div className="absolute inset-0 flex items-center justify-center bg-gray-900/50 backdrop-blur-sm rounded-full shadow-[0_0_30px_-10px_rgba(6,182,212,0.3)]">
                <Gift className="w-12 h-12 text-cyan-500/70" />
              </div>
            </div>

            <h3 className="text-2xl font-bold text-white mb-3 tracking-wide">Awaiting your first gift</h3>
            <p className="text-gray-400 mb-8 max-w-sm mx-auto leading-relaxed">
              You haven't received any gifted capsules yet. Share your address with friends to receive your first digital legacy.
            </p>
            ...
            >
              <Link
                href="/create"
                className="flex items-center gap-2 bg-gradient-to-r from-cyan-500 to-cyan-600 text-white px-10 py-4 rounded-xl font-semibold text-lg hover:from-cyan-400 hover:to-cyan-500 transition-all shadow-[0_0_15px_rgba(6,182,212,0.2)]"
              >
                <Sparkles className="w-5 h-5" />
                Create & Gift a Capsule
              </Link>
            </motion.div>
          </motion.div>
        ) : null}
